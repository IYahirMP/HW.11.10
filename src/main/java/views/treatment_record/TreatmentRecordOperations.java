...
public final class TreatmentRecordOperations extends FeedbackView {

    public TreatmentRecordOperations(HashMap<String, String> inputs){
        super(inputs);
    }

    public TreatmentRecordOperations(){
        super(new HashMap<>());
    }

    public void display(){
        System.out.println("Supported operations for TreatmentRecord entity are:");
