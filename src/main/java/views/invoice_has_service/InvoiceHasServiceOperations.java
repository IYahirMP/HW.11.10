...
public final class InvoiceHasServiceOperations extends FeedbackView {

    public InvoiceHasServiceOperations(HashMap<String, String> inputs){
        super(inputs);
    }

    public InvoiceHasServiceOperations(){
        super(new HashMap<>());
    }

    public void display(){
        System.out.println("Supported operations for InvoiceHasService relation are:");
