...
public final class EmergencyContactOperations extends FeedbackView {

    public EmergencyContactOperations(HashMap<String, String> inputs){
        super(inputs);
    }

    public EmergencyContactOperations(){
        super(new HashMap<>());
    }

    public void display(){
        System.out.println("Supported operations for EmergencyContact entity are:");
