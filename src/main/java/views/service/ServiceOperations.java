...
public final class ServiceOperations extends FeedbackView {

    public ServiceOperations(HashMap<String, String> inputs){
        super(inputs);
    }
    ...
    public void display(){
        System.out.println("Supported operations for Service entity are:");
