...
public final class PrescriptionOperations extends FeedbackView {

    public PrescriptionOperations(HashMap<String, String> inputs){
        super(inputs);
    }
    ...
    public void display(){
        System.out.println("Supported operations for Prescription entity are:");
