...
public final class DoctorOperations extends FeedbackView {

    public DoctorOperations(HashMap<String, String> inputs){
        super(inputs);
    }
    ...
    public void display(){
        System.out.println("Supported operations for Doctor entity are:");
