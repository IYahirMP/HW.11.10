...
public final class MedicineOperations extends FeedbackView {

    public MedicineOperations(HashMap<String, String> inputs){
        super(inputs);
    }
    ...
    public void display(){
        System.out.println("Supported operations for Medicine entity are:");
